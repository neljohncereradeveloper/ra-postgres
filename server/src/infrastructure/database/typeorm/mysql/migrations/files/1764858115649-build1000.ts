...
export class Build10001764858115649 implements MigrationInterface {
    name = 'Build10001764858115649'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "users" (
                ...
                "applicationaccess" character varying(500) NOT NULL,
                "userroles" character varying(500) NOT NULL,
